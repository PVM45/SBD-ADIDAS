    ...
    var s = "string",
        ...
        C = function (q) {
            ...
            b.extend({
                checkout: function () {
                    if (
                        "custom" === m.checkout.type.toLowerCase() &&
                        h(m.checkout.fn)
                    )
                ...
                var s = (this.localStorage = {
                        ...
                        clear: function () {
                            ...
                            for (
                                var e = 0;
                                (attr =
                                    f.XMLDocument.documentElement.attributes[
                                        e++
                                    ]);
