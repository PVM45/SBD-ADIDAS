        ...
        <div class="col-md-4 grid-stn simpleCart_shelfItem">
            ...
            <div class="ih-item square effect3 bottom_to_top">
                <div class="bottom-2-top">
                    {{-- src images --}}
                    {{-- {{ route('frontend-product-details',['id' => $product->id, 'slug' => $product->product_slug_en]) }}"><img src="{{ asset($product->product_thumbnail) }} --}}
                    ...
                    <div class="info">
                        <div class="pull-left styl-hdn">
                            <h3>style 01</h3>
                            {{-- nama item --}}
                            {{-- {{ route('frontend-product-details',['id' => $product->id, 'slug' => $product->product_slug_en]) }} --}}
                        </div>
