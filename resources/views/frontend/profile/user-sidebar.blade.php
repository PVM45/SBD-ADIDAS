<div class="col-md-2">
    <ul class="list-group list-group-flush">
        ...
        <a href="{{ route('author.user.profile') }}" class="btn btn-primary btn-sm btn-block">Profile Update</a>
        <a href="{{ route('author.user.change.password') }}" class="btn btn-primary btn-sm btn-block">Change Password</a>
        ...
        {{-- <a href="{{ route('user.cancel-orders') }}" class="btn btn-primary btn-sm btn-block">Cancel Orders</a> --}}<br>
