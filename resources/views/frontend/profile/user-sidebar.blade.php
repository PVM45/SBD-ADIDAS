<div class="col-md-2">
  ...
  <ul class="list-group list-group-flush">
      ...
      <a href="/user/password/change" class="btn btn-primary btn-sm btn-block">Change Password</a>
      ...
      <a href="/return/order" class="btn btn-primary btn-sm btn-block">Return Orders</a>
      {{-- <a href="{{ route('user.cancel-orders') }}" class="btn btn-primary btn-sm btn-block">Cancel Orders</a> --}}
      <a href="/cancel/order" class="btn btn-primary btn-sm btn-block">Cancel Orders</a>
